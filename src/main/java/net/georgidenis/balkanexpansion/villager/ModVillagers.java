...
//        return Registry.register(Registries.VILLAGER_PROFESSION, Identifier.of(BalkanExpansion.MOD_ID, name),
//                new VillagerProfession(name, entry -> entry.matchesKey(type), entry -> entry.matchesKey(type),
//                        ImmutableSet.of(), ImmutableSet.of(), SoundEvents.ENTITY_VILLAGER_WORK_LIBRARIAN));
//    }
//
//    private static PointOfInterestType registerPOI(String name, Block block) {
//        return PointOfInterestHelper.register(Identifier.of(BalkanExpansion.MOD_ID, name),
//                1, 1, block);
//    }
//
//    private static RegistryKey<PointOfInterestType> registerPoiKey(String name) {
//        return RegistryKey.of(RegistryKeys.POINT_OF_INTEREST_TYPE, Identifier.of(BalkanExpansion.MOD_ID, name));
//    }

    public static void registerVillagers(){
        BalkanExpansion.LOGGER.info("Registering Villagers for " + BalkanExpansion.MOD_ID);
    }
}
